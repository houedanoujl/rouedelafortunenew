...
<div class="sidebar" id="consentSidebar">
    ...
    <div class="sidebar-body">
        ...
        <p>Ces données pourront être utilisées à des fins de prises de contacts et d'études de satisfaction, sans contrepartie financière, uniquement dans le cadre de la communication des résultats de le jeu promotionnelle …... </p>
