...
<div class="modal fade" id="consentModal" tabindex="-1" aria-labelledby="consentModalLabel" aria-hidden="true" style="z-index: 1060;" data-bs-backdrop="false">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        ...
        <p>Ces données pourront être utilisées à des fins de prises de contacts et d'études de satisfaction, sans contrepartie financière, uniquement dans le cadre de la communication des résultats du jeu promotionnelle GRAND JEU 70 ANS DINOR </p>
