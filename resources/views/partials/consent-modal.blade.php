...
<div class="modal fade" id="consentModal" tabindex="-1" aria-labelledby="consentModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <p>Dans le cadre uniquement de la communication des résultats de la tombola dénommée « Promo 70 ans de la marque DINOR  », la société SANIA  est amenée à collecter des informations personnelles vous concernant à savoir vos nom, prénom(s), numéro de téléphone, adresse e-mail et image.</p>
        ...
        <p>Ces données pourront être utilisées à des fins de prises de contacts et d'études de satisfaction, sans contrepartie financière, uniquement dans le cadre de la communication des résultats de la tombola promotionnelle GRAND JEU 70 ANS DINOR </p>
